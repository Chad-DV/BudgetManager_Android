        ...
        budgetRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot snap:snapshot.getChildren()){
                    ...
                    String sTotal = String.valueOf("Month budget: R" + totalAmount);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (budgtItem.equals("Select item")){
                    ...
                    String itemInDay = budgtItem + date;
                    String itemInWeek = budgtItem + weeks.getWeeks();
                    String itemInMonth = budgtItem + months.getMonths();


                    Data data =  new Data(budgtItem,date,id,null,itemInDay,itemInWeek, itemInMonth, Integer.parseInt(budgetAmount),weeks.getWeeks(),months.getMonths());
    ...
    protected void onStart(){
        ...
        FirebaseRecyclerAdapter<Data, MyViewHolder> adapter = new FirebaseRecyclerAdapter<Data, MyViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull MyViewHolder holder, int position, @NonNull  Data model) {
                holder.setItemAmount("Allocated amount: R" + model.getAmount());
    ...
    private void updateData(){
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String itemInDay = item + date;
                String itemInWeek = item + weeks.getWeeks();
                String itemInMonth = item + months.getMonths();


                Data data =  new Data(item,date,post_key,null,itemInDay,itemInWeek, itemInMonth,amount,weeks.getWeeks(),months.getMonths());
