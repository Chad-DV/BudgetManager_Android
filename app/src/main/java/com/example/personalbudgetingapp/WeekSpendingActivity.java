        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Item.equals("Select item")){
                    Toast.makeText(WeekSpendingActivity.this,"Select a valid item" , Toast.LENGTH_SHORT).show();
                }
                ...
                if (TextUtils.isEmpty(notes)){
                    ...
                    Data data = new Data(Item,date,id,notes,itemInDay,itemInWeek, itemInMonth, Integer.parseInt(Amount),weeks.getWeeks(),months.getMonths());
                    expensesRef.child(id).setValue(data).addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()){
                                Toast.makeText(WeekSpendingActivity.this, "Budget item added successfully",Toast.LENGTH_SHORT).show();
                            }else{
                                Toast.makeText(WeekSpendingActivity.this, task.getException().toString(),Toast.LENGTH_SHORT).show();
                            }
